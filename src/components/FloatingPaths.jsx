  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute inset-x-0 top-0 h-32 z-10"
        style={{ background: 'linear-gradient(to bottom, var(--color-background, #050505), transparent)' }} />
      {/* Fade bottom */}
      <div className="absolute inset-x-0 bottom-0 h-32 z-10"
        style={{ background: 'linear-gradient(to top, var(--color-background, #050505), transparent)' }} />
