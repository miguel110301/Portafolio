...
const EXPERIENCE_COPY = {
  es: {
    protocol: 'Registro_Trayectoria',
    title: 'Experiencia.',
    experiences: [
      {
        year: 'Ene 2026 - Actualidad',
        role: 'Ingeniero de Backend y Automatizacion',
        company: 'Sistemas Logisticos (Remoto)',
        description: 'Arquitectura de sistemas de automatizacion orientados a eventos. Integracion de flujos n8n con APIs en Django y WhatsApp Business API para optimizacion logistica.',
      ...
      },
      {
        ...
        company: 'Remoto',
        description: 'Diseno y despliegue de microservicios backend y APIs REST. Administracion de infraestructura en entornos Linux con Nginx y Gunicorn.',
        tech: ['REST APIs', 'Linux', 'Docker', 'Gunicorn'],
      },
    ],
  },
  en: {
    protocol: 'Trajectory_Log',
    title: 'Experience.',
    experiences: [
      {
