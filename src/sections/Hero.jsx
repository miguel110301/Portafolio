    ...
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center mt-10">
        ...
        <motion.h1 
          ...
          className="text-5xl md:text-7xl font-extrabold tracking-tight text-primary mb-6 leading-[1.1] max-w-4xl"
        >
          I architect systems that <br className="hidden md:block"/>
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-muted max-w-2xl mb-10 leading-relaxed font-light"
        >
